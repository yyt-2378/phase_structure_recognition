...
if __name__ == '__main__':
    path = 'F:\\MOLECULE dataset\\training'  # Path to images
    label_path = 'F:\\MOLECULE dataset\\label_annotation'  # Path to labels
    output_path = 'F:\\STEM_img'  # Output path
    output_label_path = 'F:\\STEM_label'  # Output path

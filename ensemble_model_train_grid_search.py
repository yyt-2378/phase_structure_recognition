...
if __name__ == '__main__':
    ...
    for idx, (train_batch_size, learning_rate, max_epochs) in enumerate(param_combinations):
        ...
        shutil.copy('/root/autodl-tmp/phase_structure_recognition/preprocess_model/configs/option.py', tb_logger.log_dir)
        # 训练结束后清理释放内存和显存
        cleanup()
        
        print(f"======= Finished training and cleanup done =======")
        sleep(3)
